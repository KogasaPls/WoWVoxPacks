...
-- Event Handlers
--
local path = "Interface\\AddOns\\BigWigs_Voice_WoWVoxPacks_Studio_Q\\Sounds\\%s.ogg"
local pathYou = "Interface\\AddOns\\BigWigs_Voice_WoWVoxPacks_Studio_Q\\Sounds\\%sy.ogg"
