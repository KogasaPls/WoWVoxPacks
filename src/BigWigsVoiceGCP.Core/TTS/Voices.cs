namespace BigWigsVoiceGCP.TTS;

public static class Voices
{
    public static string GetVoiceName(VoiceName voiceName, string languageCode = "en-US")
    {
        return languageCode switch
        {
            "en-US" => EnUS.GetVoiceName(voiceName),
    ...
    {
        public static string GetVoiceName(VoiceName voiceName)
        {
