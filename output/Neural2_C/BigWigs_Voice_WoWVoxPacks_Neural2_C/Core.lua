...
-- Event Handlers
--
local path = "Interface\\AddOns\\BigWigs_Voice_WoWVoxPacks_Neural2_C\\Sounds\\%s.ogg"
local pathYou = "Interface\\AddOns\\BigWigs_Voice_WoWVoxPacks_Neural2_C\\Sounds\\%sy.ogg"
