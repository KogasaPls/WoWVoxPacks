...
-- Event Handlers
--
local path = "Interface\\AddOns\\BigWigs_Voice_WoWVoxPacks_Standard_D\\Sounds\\%s.ogg"
local pathYou = "Interface\\AddOns\\BigWigs_Voice_WoWVoxPacks_Standard_D\\Sounds\\%sy.ogg"
